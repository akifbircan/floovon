...
/**
 * Fatura HTML'i oluşturur
 * @param {Object} params - Fatura parametreleri
 * @param {string} params.faturaNo - Fatura numarası
 * @param {string|Date} params.faturaTarihi - Fatura tarihi
 * @param {string|Date|null} params.odemeTarihi - Ödeme tarihi (opsiyonel)
 * @param {string} params.company_name - Şirket adı
 * @param {string} [params.address=''] - Adres
 * @param {string} [params.city=''] - Şehir
 * @param {string} [params.state=''] - İl/State
 * @param {Array|null} [params.tenantInfo=null] - Tenant bilgileri (vergi dairesi, vergi no için)
 * @param {string} params.itemDescription - Ürün/hizmet açıklaması
 * @param {string} [params.itemDescriptionDetail=''] - Detay açıklama
 * @param {number} params.araToplam - Ara toplam (kuruş cinsinden)
 * @param {number} params.kdvTutari - KDV tutarı (kuruş cinsinden)
 * @param {number} params.toplamTutar - Toplam tutar (kuruş cinsinden)
            ...
            <div class="invoice-container">
                <div class="invoice-header">
                    <div class="invoice-header-left">
                        ...
                        <div class="invoice-date">Düzenleme Tarihi: ${new Date(faturaTarihi).toLocaleDateString('tr-TR', { day: '2-digit', month: 'long', year: 'numeric' })}</div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                ${itemDescription}
                                ${itemDescriptionDetail ? `<div class="item-description">${itemDescriptionDetail}</div>` : ''}
                            </td>
                ...
                <div class="invoice-totals">
                    <div class="invoice-totals-row">
                        ...
                        <span>${(araToplam / 100).toLocaleString('tr-TR', { minimumFractionDigits: 2 })} ₺</span>
                    </div>
                    <div class="invoice-totals-row">
                        <span>KDV (%${kdvOrani})</span>
                        <span>${(kdvTutari / 100).toLocaleString('tr-TR', { minimumFractionDigits: 2 })} ₺</span>
                    </div>
                    <div class="invoice-totals-row total">
                        <span>Toplam Tutar</span>
                        <span>${(toplamTutar / 100).toLocaleString('tr-TR', { minimumFractionDigits: 2 })} ₺</span>
                    </div>
                </div>
